...
<div align="center">
  ...
  <h1>@applaud/CSS Loader</h1>
</div>

<h2 align="center">Install</h2>

```bash
npm install --save-dev @applaud/css-loader
```

<h2 align="center">Usage</h2>

The `@applaud/css-loader` interprets `@import` and `url()` like `import/require()`
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.css$/,
        use: [ 'style-loader', '@applaud/css-loader' ]
      }
    ]
  }
}
